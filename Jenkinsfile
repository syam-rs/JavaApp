    ...
    stages {
        ...
        stage ('Publish to Nexus'){
            steps {
                ...
                def NexusRepo = Version.endsWith("SNAPSHOT") ? "SyamsDevOpsLab-SNAPSHOT" : "SyamsDevOpsLab-Release"
                ...
                type: 'war']], 
                credentialsId: 'c4091161-8950-4632-85b5-9e8ea59158ed', 
                groupId: "${GroupId}", 
                nexusUrl: '172.20.10.198:8081', 
                nexusVersion: 'nexus3', 
                protocol: 'http', 
